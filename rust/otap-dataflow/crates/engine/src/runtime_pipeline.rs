...
use otel_arrow_dfe_pdata::codec::CodecExecutors;
    ...
    RuntimePipeline<PData>
{
    ...
    pub fn run_forever(
        ...
        let codec_executors = CodecExecutors::default();
        ...
        for exporter in exporters {
            ...
            let exporter_codec_executors = codec_executors.clone();
            let fut = async move {
                match exporter
        ...
        for processor in processors {
            ...
            let processor_codec_executors = codec_executors.clone();
        ...
        for receiver in receivers {
            ...
            let receiver_codec_executors = codec_executors.clone();
            let fut = async move {
                match receiver
                    .start_with_codec_executors(
                        runtime_ctrl_msg_tx,
                        pipeline_completion_msg_tx,
                        effect_metrics_reporter,
                        node_interests,
                        receiver_codec_executors,
                    )
                    .await
                {
                    Ok(terminal_state) => {
