...
use otel_arrow_dfe_pdata::codec::SharedCodecExecutor;
...
pub struct EffectHandler<PData> {
    ...
    codec_executor: SharedCodecExecutor,
...
impl<PData> EffectHandler<PData> {
    ...
    pub fn new(node_id: NodeId, metrics_reporter: MetricsReporter) -> Self {
        EffectHandler {
            ...
            codec_executor: SharedCodecExecutor::default(),
            _pd: PhantomData,
    ...
    #[doc(hidden)]
    #[must_use]
    pub const fn codec_executor(&self) -> &SharedCodecExecutor {
        &self.codec_executor
    }

    pub(crate) fn set_codec_executor(&mut self, codec_executor: SharedCodecExecutor) {
