...
| `durable_buffer.retry.schedule_failed` | `warn` | Failed to schedule the aggregate retry wakeup for a transiently NACKed bundle. |
...
| `durable_buffer.delayed_data.unexpected` | `warn` | Unexpected `DelayedData` message received; discarded. |
