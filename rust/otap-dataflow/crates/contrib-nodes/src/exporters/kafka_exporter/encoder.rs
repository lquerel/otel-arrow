...
/// # Arguments
///
/// * `otap_records` - The native OTAP records to encode
...
mod tests {
    ...
    /// Scenario: Kafka receives an OTLP payload already encoded for its output format.
    /// Guarantees: the compatibility helper forwards the exact protobuf contents.
    #[test]
