...
"#;
        ...
        assert_eq!(global_default.backend, crate::topic::TopicBackend::InMemory);
        ...
        assert_eq!(global_queue.backend, crate::topic::TopicBackend::Quiver);
        ...
        assert_eq!(local_queue.backend, crate::topic::TopicBackend::Quiver);
