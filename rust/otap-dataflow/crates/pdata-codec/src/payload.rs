...
use crate::{
    CodecError, CodecService, EncodeOutput, EncodedPdata, EncodingPlan, InspectionPlan,
    PdataEncoding, PdataView, ResolvedCodec,
};
...
mod tests {
    ...
    use super::*;
    use crate::{CodecMetadata, CodecRegistration, CodecRegistry};
